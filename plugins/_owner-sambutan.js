// const owner1 = '628581933381@s.whatsapp.net';
// const owner2 = '@s.whatsapp.net';
const owner3 = '628581933381@s.whatsapp.net';
...
handler.before = async function(m, { conn, participants, isPrems, isAdmin }) {
  ...
  switch (m.sender) {
    // case `${owner1}`:
    //   messageText = "📣 *Perhatian semua* 📣, Pangeran telah datang";
    //   break;
    // case `${owner2}`:
    //   messageText = "📣 *Perhatian semua* 📣, Pangeran sudah datang datang";
    //   break;
    case `${owner3}`:
      messageText = "📣 *Perhatian semua* 📣, Pangeran kerjaan telah datang, beri hormat semua!!!";
      break;
    // case "628581933381@s.whatsapp.net":
    //   messageText = "📣 *Perhatian semua*, Pangeran telah datang";
    //   break;  
  }
